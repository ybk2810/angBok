  ...
  <button type="submit"><i class="fa fa-search"></i></button>
		...
		<table >
			<tr >
				...
				<td style=" width: 220px; height: 200px; border-radius: 50%; position: relative; left: 150px; top: 100px;">
					...
					<p style="text-align: center;"><strong>~${dto.name }~</strong></p><h6 style="color: gray; text-align: center;">${dto.intro }</h6>
